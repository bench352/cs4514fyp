        ...
        <Dialog open={props.open} fullWidth maxWidth="xs">
            ...
            <DialogContent>
                <Stack
                    ...
                    spacing={2}
                >
                    <TextField fullWidth label="Username" id="fullWidth" value={username} variant="standard" onChange={
                        (e) => {
                            setUsername(e.target.value)
                        }}
                    />
                    <TextField fullWidth label="Full Name" id="fullWidth" value={fullname} variant="standard" onChange={
                        (e) => {
                    ...
                    <TextField fullWidth label="Initial Password" id="fullWidth" value={initPassword} variant="standard"
                               onChange={
                                   (e) => {
