  ...
  return (
    <>
      ...
      <Typography variant="body1" gutterBottom>
        Smart Home Management System offers a suite of tools for managing and
        monitoring entities in your buildings more easily. Here are what you can
        do in the system:
      </Typography>
      <List>
        <ListItem>
        ...
        <ListItem>
          ...
          <ListItemText
            primary="Real-time Telemetry Data"
...
function ResidentHomePage(props: { userDetail: UserDetail }) {
  return (
    <>
      ...
      <Typography variant="h3" gutterBottom fontWeight="bold">
        {props.userDetail.flat
          ? props.userDetail.flat.name
          : "Smart Home Management System"}
      </Typography>
      {props.userDetail.flat === null ? (
        <Alert variant="filled" severity="warning">
          <AlertTitle>
            Attention: Your account has not been assigned to a flat yet!
          </AlertTitle>
          Your access to the system is not available until your landlord assigns
          your account to a specific flat. Please reach out to your landlord for
          further assistance.
        </Alert>
      ) : (
        <>
          <Typography variant="body1" gutterBottom>
            As a resident, you can enjoy the convenience of an IoT-powered
            residence and access all IoT devices within your apartment unit
            using the Smart Home Management System. Here are what you can do in
            the system:
          </Typography>
          <List>
            <ListItem>
          ...
          <Typography variant="body1" gutterBottom>
            As a resident, you have limited access to the system - you can only
            view IoT device data that belongs to your apartment unit, but not
            everything else. If you need to update information on your devices
            or your account, or if you need elevated permission, please contact
