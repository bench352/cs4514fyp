      ...
      >
        ...
        <div>
          ...
          <Typography variant="body1" gutterBottom>
            All the users in your building. Control their access by setting
            roles and the flats they can access.
          </Typography>
        </div>
      </Stack>
      <TransitionGroup>
        {userDetails.map((userDetail) => (
          <Collapse key={userDetail.id}>
            <UserCard key={userDetail.id} userDetail={userDetail} />
          </Collapse>
        ))}
      </TransitionGroup>
      <UpdateUserDialog
