...
export default function UIContainer() {
    ...
    <div>
      ...
      {userDetail?.role === "LANDLORD" ? (
        <>
          <List
            subheader={
              <ListSubheader component="div">Entity Management</ListSubheader>
            }
          >
      ...
      <List
        subheader={
          <ListSubheader component="div">Real-time Monitoring</ListSubheader>
        }
      >
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <CurrentUserDialog
        setShowDialog={setShowCurrentUserDialog}
        createErrorSnackBar={createErrorSnackBar}
        setShowLoading={setShowLoading}
        open={showCurrentUserDialog}
