...
export async function createUser(token: string, user: UserCreate): Promise<void> {
    const response = await fetch(env.REACT_APP_EMA_SERVICE_URL + `/users`, {
        method: "POST",
        headers: {
            "Authorization": `Bearer ${token}`,
...
export async function updateUser(token: string, user: UserUpdate): Promise<void> {
    const response = await fetch(env.REACT_APP_EMA_SERVICE_URL + `/users`, {
        method: "PUT",
        headers: {
            "Authorization": `Bearer ${token}`,
...
export async function addFlatToUser(token: string, userId: string, flatId: string): Promise<void> {
    const response = await fetch(env.REACT_APP_EMA_SERVICE_URL + `/users/${userId}/flats`, {
        method: "POST",
        headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json",
